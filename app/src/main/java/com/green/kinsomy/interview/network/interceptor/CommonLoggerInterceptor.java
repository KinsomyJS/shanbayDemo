package com.green.kinsomy.interview.network.interceptor;
...
public class CommonLoggerInterceptor implements Interceptor
{
    public static final String TAG = "green";
    private String tag;
    private boolean showResponse;

    public CommonLoggerInterceptor(String tag, boolean showResponse)
    {
    ...
    public CommonLoggerInterceptor(String tag)
    {
        this(tag, false);
    }
